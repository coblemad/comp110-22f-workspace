...
def test_favorite_color_use1() -> None:
    ...
    color_list: dict({"Madelyn": "pink", "Molly": "yellow", "Leah": "red", "Alaina": "pink"})
...
def test_favorite_color_use2() -> None:
    ...
    color_list: dict({"Trixie": "pink", "Katya": "purple", "Todrick": "purple"})
