...
def quiz() -> None:
    print("Now it is time to start the quiz. Please pick one statement that best describes you and type True next to it. Type False next to the other qualities that are not your choice. ")
    question_one: bool = input("1: You enjoy the classics, whether it's music, clothing, cars, etc. ")
    question_two: bool = input("2: You have a bubbly personality and others would describe you as outgoing.")
    question_three: bool = input("3: You are sort of mysterious and are a quieter person. ")
    question_four: bool = input("4: You enjoy volunteering and are kind, always ready to make meaningful connections. ")
    question_five: bool = input("5: You are always laughing and make the best out of life. ")
